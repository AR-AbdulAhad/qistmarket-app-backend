...
const { getOtpSettings } = require('../utils/otpSettingsUtils');
...
// imports `sendOtp` from here instead of watiService directly. Channel settings
// are controlled dynamically via the Admin Dashboard UI (with .env fallback).
//
//   wati_enabled: true/false   — WhatsApp OTP via WATI
//   jazz_enabled: true/false   — SMS OTP via Jazz CMT
//
...
const isWatiEnabled = () => getOtpSettings().wati_enabled;
const isJazzEnabled = () => getOtpSettings().jazz_enabled;
